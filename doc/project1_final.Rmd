...
<br>
It doesn't give us too much information about their plans because every president would say the same words on their inaugural speeches. So we use the TF-IDF method to control the weight of those common words and take a further look.
<br>
...
<br>
I have tried using the topic models for investigating the popular topics in the speech, but the result is too general--most of them are about the nation and American spirits. Thus I tried to define my own dictionary using the most common 1000 words extracted from president speeches after 1920.
<br>
...
<br>
Here I have manually picked 6 topics(economy, employment, national security, production, geopolitics, education) that I'm interested in and also some popular words under these topics.
<br>
...
<br>
We also conducted a sentiment analysis.
```{r}
...
<br>
The graph shows that there's strong cooccurence among economy, employment and national security, which does make sense.
<br>
